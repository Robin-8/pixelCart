...
function changeFunc() {
  ...
  if (selectedValue == 'India') {
    document.getElementById('flag-icon').src = 'https://swagofindia.netlify.app/Images/langicon.png';
    document.getElementById('ph-number').innerHTML = '+91 9838203708';
  } else if (selectedValue == 'UK') {
    document.getElementById('flag-icon').src = 'https://swagofindia.netlify.app/Images/UK-flag.png';
    document.getElementById('ph-number').innerHTML = '+44 1632 960846';
  } else if (selectedValue == 'Canada') {
    document.getElementById('flag-icon').src = 'https://swagofindia.netlify.app/Images/canada-flag.png';
    document.getElementById('ph-number').innerHTML = '+1 202 555 0156';
  } else {
    document.getElementById('flag-icon').src = 'https://swagofindia.netlify.app/Images/german-flag.png';
...
document.querySelectorAll(".prod-card").forEach(img => {
  ...
  img_1.addEventListener('mouseover', func2 => {
    img_1.src = 'https://swagofindia.netlify.app/Images/heart-icon-trans.png';
  })
});
document.querySelectorAll(".prod-card").forEach(img => {
  let img_1 = img.childNodes[1].childNodes[1].childNodes[0]
...
document.querySelectorAll(".prod-card").forEach(img => {
  ...
  img_2.addEventListener('mouseover', func3 => {
    img_2.src = 'https://swagofindia.netlify.app/Images/eye-icon-trans.png';
  })
});
document.querySelectorAll(".prod-card").forEach(img => {
  let img_2 = img.childNodes[1].childNodes[3].childNodes[0]
...
document.querySelectorAll(".prod-card").forEach(img => {
  ...
  img_3.addEventListener('mouseover', func4 => {
    img_3.src = 'https://swagofindia.netlify.app/Images/shopping-icon-trans.png';
  })
});
document.querySelectorAll(".prod-card").forEach(img => {
  let img_3 = img.childNodes[1].childNodes[5].childNodes[0]
...
.then(json => {
      ...
      productsList.products.forEach((product) => {
          ...
          `<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="prod-card mb-4" id='${product.id}'>
              <div class="icons d-flex justify-content-center" id="card_icons">
                <a class="heart"><img class='img1' src="https://swagofindia.netlify.app/Images/heart-icon-trans.png" alt="inner heart icon"></a>
                <a href="Product-view.html"><img src="https://swagofindia.netlify.app/Images/eye-icon-trans.png" alt="inner eye icon"></a>
                <a class="shopping"><img src="https://swagofindia.netlify.app/Images/shopping-icon-trans.png" alt="inner shopping icon"></a>
              </div>
        ...
        for (i = 1; i <= product.ratings; i++) {
          reviews += `
                  <img class="stars" src="https://swagofindia.netlify.app/Images/star.png" alt="star-rating" role="icon" aria-label='star rating'>`;
        }
        for (i = 1; i <= lowStar; i++) {
          reviews += `<img class="stars" src="https://swagofindia.netlify.app/Images/star-empty.png" alt="star-rating" role="icon" aria-label='star rating'>`;
        }
        lowStar = 0;
